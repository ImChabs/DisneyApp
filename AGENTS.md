...
Use `docs/disneyapp_blueprint.md` as the product source of truth. Keep the app focused: a native Android portfolio app for browsing Disney characters, searching by name, viewing details, and saving local favorites.
