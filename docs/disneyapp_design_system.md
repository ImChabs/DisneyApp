# DisneyApp Design System

This document is the source of truth for DisneyApp's visual direction. Keep the app visually consistent across character list, detail, favorites, loading, empty, and error states.

## Visual Direction

DisneyApp uses a premium Disney-inspired style:
...
- Use `DisneyAppTheme` for Material 3 theming.
...
- `app/src/main/java/com/example/disneyapp/ui/theme/Color.kt`
- `app/src/main/java/com/example/disneyapp/ui/theme/Brushes.kt`
- `app/src/main/java/com/example/disneyapp/ui/theme/Theme.kt`
...
- Do not duplicate this document in `AGENTS.md` or `docs/disneyapp_blueprint.md`; those files should only reference it.
- Keep visual rules aligned with `docs/disneyapp_blueprint.md`: no marketing pages, auth, social features, payments, ads, or unrelated product expansion.
